  ...
  const handleSubmit = () => {
    ...
    for (let q of questions) {
      if (!q.questionText || !q.optionA || !q.optionB || !q.optionC || !q.optionD || !q.correctAnswer) {
        return alert("All fields in questions are required");
      }
    }

axios.post("http://localhost:8080/api/quiz/add-with-questions", { 
    title,
    createdByRole: role,
    createdByUsername: username, // important
    questions
})
      .then(() => {
        alert("Quiz added!");
    ...
    <Container maxWidth="md">
      <Paper sx={{ mt: 8, p: 4 }}>
        ...
        <Box display="flex" justifyContent="space-between" mt={3}>
          <Button variant="outlined" startIcon={<AddCircle />} onClick={handleAddQuestion}>
            Add Question
          </Button>
